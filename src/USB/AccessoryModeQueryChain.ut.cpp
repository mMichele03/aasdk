...
class AccessoryModeQueryChainUnitTest {
   protected:
    AccessoryModeQueryChainUnitTest()
        : deviceHandle_(reinterpret_cast<libusb_device_handle*>(&dummyDeviceHandle_), [](auto*) {}), queryMock_(std::make_shared<AccessoryModeQueryMock>()), promise_(IAccessoryModeQueryChain::Promise::defer(ioService_)) {
